class Producto {
    constructor(codigo, imagen, tipo, marca, modelo, medida, otro, precio,) {
        this.codigo = codigo;
        this.imagen = imagen;
        this.tipo = tipo;
        this.marca = marca;
...
// Filtros
const PROD10 = new Producto("25508-4", "./img/man c30171.jpeg","FILTROS", "MANN", "C30171", "", "FILTRO AIRE", 9900);
const PROD11 = new Producto("25479-7", "./img/mann hu 718:5X.jpeg","FILTROS", "MANN", "HU718/5X", "", "FILTRO ELEMENTO", 9700);
const PROD12 = new Producto("26007-K", "./img/mann w610:6.jpeg","FILTROS", "MANN", "W610/6", "", "FILTRO ACEITE", 6280);
// Aromatizantes
...
BTN.addEventListener("click", function() {
    ...
    } else if (FILTRO_TIPO && (FILTRO_TIPO === "155/65R13" || FILTRO_TIPO === "185/65R14" || FILTRO_TIPO === "175/60R15" || FILTRO_TIPO === "45AH" || FILTRO_TIPO === "55AH" || FILTRO_TIPO === "60AH" || FILTRO_TIPO === "5W-30" || FILTRO_TIPO === "15W-40" || FILTRO_TIPO === "10W-40" || FILTRO_TIPO === "" || FILTRO_TIPO === "" || FILTRO_TIPO === "" || FILTRO_TIPO === "" || FILTRO_TIPO === "" || FILTRO_TIPO === "")) {
        
        const PRODUCTOS_FILTRADOS = ARRAY_PRODUCTOS.filter(contenedor__box => contenedor__box.medida === FILTRO_TIPO);
        cargarProductos(PRODUCTOS_FILTRADOS);
        TITULO_PRINCIPAL.innerText = capitalizarPrimeraLetra(FILTRO_TIPO);
    
    } else if (FILTRO_TIPO && (FILTRO_TIPO === "" || FILTRO_TIPO === "" || FILTRO_TIPO === "" || FILTRO_TIPO === "450CCA" || FILTRO_TIPO === "480CCA" || FILTRO_TIPO === "600CCA" || FILTRO_TIPO === "BENCINA" || FILTRO_TIPO === "BENCINA" || FILTRO_TIPO === "PETROLEO" || FILTRO_TIPO === "FILTRO AIRE" || FILTRO_TIPO === "FILTRO ELEMENTO" || FILTRO_TIPO === "FILTRO ACEITE" || FILTRO_TIPO === "VAINILLA" || FILTRO_TIPO === "FLORAL" || FILTRO_TIPO === "SPORT")) {
