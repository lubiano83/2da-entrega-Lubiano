...
class Producto {
    constructor(codigo, imagen, tipo, marca, modelo, medida, otro, cantidad, precio,) {
        this.codigo = codigo;
        this.imagen = imagen;
        this.tipo = tipo;
        this.marca = marca;
...
// Neumaticos
const PROD1 = new Producto("50170-0", "./img/hankook K715.jpeg","NEUMATICOS", "HANKOOK", "K715", "155/65R13", "","4", 59890);
const PROD2 = new Producto("50174-3", "./img/hankook H724.jpeg","NEUMATICOS", "HANKOOK", "H724", "185/65R14", "","4", 59890);
const PROD3 = new Producto("50595-1", "./img/hankook H308.jpeg","NEUMATICOS", "HANKOOK", "H308", "175/60R15", "","4", 49890);
// Baterias
...
function cargarProductos (productosElegidos){
    ...
    productosElegidos.forEach(contenedor__box => {
        ...
        ARTICLE.innerHTML = `
            <div class="box__foto">
                <img src="${contenedor__box.imagen}" alt="${contenedor__box.tipo},${contenedor__box.marca},${contenedor__box.modelo},${contenedor__box.medida},${contenedor__box.otro}" class="foto">
            </div>
